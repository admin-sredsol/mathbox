...
export interface MathboxSelection<Type extends NodeType = NodeType> {
     ...
     * are "live" and re-evaluated on clock frames. See [API Overview](https://github.com/unconed/mathbox/blob/master/docs/api.md#api-overview).
     */
    bind<P extends keyof Props[Type]>(prop: P, value: (time: number, delta: number) => Props[Type][P]): MathboxSelection<Type>;
    /**
     ...
     * @category view
     */
    stereographic(props?: TT.StereographicProps, liveProps?: LiveProps<TT.StereographicProps>): MathboxSelection<"stereographic">;
    /**
     ...
     * @category view
     */
    stereographic4(props?: TT.Stereographic4Props, liveProps?: LiveProps<TT.Stereographic4Props>): MathboxSelection<"stereographic4">;
    /**
