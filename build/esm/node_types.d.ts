 ...
 * @category data
 */
export interface AreaPropsNormalized extends GetTraitsNode, GetTraitsBuffer, GetTraitsData, GetTraitsMatrix, GetTraitsTexture, GetTraitsArea, Suffixed<GetTraitsSpan, "X">, Suffixed<GetTraitsSpan, "Y">, Suffixed<GetTraitsSampler, "X">, Suffixed<GetTraitsSampler, "Y"> {
 ...
 * @category data
 */
export interface AreaProps extends SetTraitsNode, SetTraitsBuffer, SetTraitsData, SetTraitsMatrix, SetTraitsTexture, SetTraitsArea, Suffixed<SetTraitsSpan, "X">, Suffixed<SetTraitsSpan, "Y">, Suffixed<SetTraitsSampler, "X">, Suffixed<SetTraitsSampler, "Y"> {
    expr?: AreaEmitter;
}
/**
 ...
 * @category draw
 */
export interface GridPropsNormalized extends GetTraitsNode, GetTraitsObject, GetTraitsStyle, GetTraitsLine, GetTraitsGrid, GetTraitsArea, GetTraitsOrigin, Suffixed<GetTraitsAxis, "X">, Suffixed<GetTraitsAxis, "Y">, Suffixed<GetTraitsScale, "X">, Suffixed<GetTraitsScale, "Y">, Suffixed<GetTraitsSpan, "X">, Suffixed<GetTraitsSpan, "Y"> {
}
/**
 * Properties for {@link MathboxSelection.grid | grid}.
 * @category draw
 */
export interface GridProps extends SetTraitsNode, SetTraitsObject, SetTraitsStyle, SetTraitsLine, SetTraitsGrid, SetTraitsArea, SetTraitsOrigin, Suffixed<SetTraitsAxis, "X">, Suffixed<SetTraitsAxis, "Y">, Suffixed<SetTraitsScale, "X">, Suffixed<SetTraitsScale, "Y">, Suffixed<SetTraitsSpan, "X">, Suffixed<SetTraitsSpan, "Y"> {
}
/**
 ...
 * @category data
 */
export interface LatchPropsNormalized extends GetTraitsNode, GetTraitsLatch, GetTraitsEntity {
}
/**
 * Properties for {@link MathboxSelection.latch | latch}.
 * @category data
 */
export interface LatchProps extends SetTraitsNode, SetTraitsLatch, SetTraitsEntity {
}
/**
 ...
 * @category operator
 */
export interface LerpPropsNormalized extends GetTraitsNode, GetTraitsOperator, GetTraitsLerp, Suffixed<GetTraitsSampler, "X">, Suffixed<GetTraitsSampler, "Y">, Suffixed<GetTraitsSampler, "Z">, Suffixed<GetTraitsSampler, "W"> {
}
/**
 * Properties for {@link MathboxSelection.lerp | lerp}.
 * @category operator
 */
export interface LerpProps extends SetTraitsNode, SetTraitsOperator, SetTraitsLerp, Suffixed<SetTraitsSampler, "X">, Suffixed<SetTraitsSampler, "Y">, Suffixed<SetTraitsSampler, "Z">, Suffixed<SetTraitsSampler, "W"> {
}
/**
 ...
 * @category operator
 */
export interface ResamplePropsNormalized extends GetTraitsNode, GetTraitsOperator, GetTraitsResample, GetTraitsInclude, Suffixed<GetTraitsSampler, "X">, Suffixed<GetTraitsSampler, "Y">, Suffixed<GetTraitsSampler, "Z">, Suffixed<GetTraitsSampler, "W"> {
}
/**
 * Properties for {@link MathboxSelection.resample | resample}.
 * @category operator
 */
export interface ResampleProps extends SetTraitsNode, SetTraitsOperator, SetTraitsResample, SetTraitsInclude, Suffixed<SetTraitsSampler, "X">, Suffixed<SetTraitsSampler, "Y">, Suffixed<SetTraitsSampler, "Z">, Suffixed<SetTraitsSampler, "W"> {
}
/**
 * Normalized properties for {@link MathboxSelection.retext | retext}.
 * @category text
 */
export interface RetextPropsNormalized extends GetTraitsNode, GetTraitsOperator, GetTraitsResample, GetTraitsInclude, Suffixed<GetTraitsSampler, "X">, Suffixed<GetTraitsSampler, "Y">, Suffixed<GetTraitsSampler, "Z">, Suffixed<GetTraitsSampler, "W"> {
}
/**
 * Properties for {@link MathboxSelection.retext | retext}.
 * @category text
 */
export interface RetextProps extends SetTraitsNode, SetTraitsOperator, SetTraitsResample, SetTraitsInclude, Suffixed<SetTraitsSampler, "X">, Suffixed<SetTraitsSampler, "Y">, Suffixed<SetTraitsSampler, "Z">, Suffixed<SetTraitsSampler, "W"> {
}
/**
 ...
 * @category operator
 */
export interface ReversePropsNormalized extends GetTraitsNode, GetTraitsOperator, GetTraitsReverse {
}
/**
 * Properties for {@link MathboxSelection.reverse | reverse}.
 * @category operator
 */
export interface ReverseProps extends SetTraitsNode, SetTraitsOperator, SetTraitsReverse {
}
/**
 ...
 * @category data
 */
export interface VolumePropsNormalized extends GetTraitsNode, GetTraitsBuffer, GetTraitsData, GetTraitsTexture, GetTraitsVoxel, GetTraitsVolume, Suffixed<GetTraitsSpan, "X">, Suffixed<GetTraitsSpan, "Y">, Suffixed<GetTraitsSpan, "Z">, Suffixed<GetTraitsSampler, "X">, Suffixed<GetTraitsSampler, "Y">, Suffixed<GetTraitsSampler, "Z"> {
 ...
 * @category data
 */
export interface VolumeProps extends SetTraitsNode, SetTraitsBuffer, SetTraitsData, SetTraitsTexture, SetTraitsVoxel, SetTraitsVolume, Suffixed<SetTraitsSpan, "X">, Suffixed<SetTraitsSpan, "Y">, Suffixed<SetTraitsSpan, "Z">, Suffixed<SetTraitsSampler, "X">, Suffixed<SetTraitsSampler, "Y">, Suffixed<SetTraitsSampler, "Z"> {
    expr?: VolumeEmitter;
}
/**
